...
export async function POST(req: NextRequest) {
  ...
  const {
    ...
    adresse, chambres, sallesDeBain, sallesEau, superficie, anneeConstruction,
    stationnement, style, sousType, superficieTerrain, chauffage, eauChaude,
    climatisation, sousSol, revetement, piscine, extras,
    stInterieur, stExterieur, prixNegociable,
    nbLogements, revenusBruts, depensesAnnuelles, logementsLibres, occupationProprio,
    contactPrefere, courriel, disponibilites,
    taxesMunicipales, taxesScolaires, fraisCondo,
  ...
  const listing = await prisma.listing.create({
    data: {
      ...
      stInterieur: stInterieur || null,
      stExterieur: stExterieur || null,
      prixNegociable: prixNegociable ?? true,
      nbLogements: nbLogements || null,
      revenusBruts: revenusBruts || null,
      depensesAnnuelles: depensesAnnuelles || null,
      logementsLibres: logementsLibres || null,
      occupationProprio: occupationProprio ?? false,
      contactPrefere: contactPrefere || null,
