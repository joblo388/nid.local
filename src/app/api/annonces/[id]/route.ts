...
export async function GET(_req: NextRequest, ctx: Ctx) {
  ...
  return NextResponse.json({
    ...
    sousSol: listing.sousSol,
    revetement: listing.revetement,
    extras: listing.extras,
    stInterieur: listing.stInterieur,
    stExterieur: listing.stExterieur,
    prixNegociable: listing.prixNegociable,
    nbLogements: listing.nbLogements,
    revenusBruts: listing.revenusBruts,
    depensesAnnuelles: listing.depensesAnnuelles,
    logementsLibres: listing.logementsLibres,
    occupationProprio: listing.occupationProprio,
    contactPrefere: listing.contactPrefere,
    courriel: listing.courriel,
    disponibilites: listing.disponibilites,
