  ...
  return (
    ...
    >
      <div className="max-w-[1100px] lg:max-w-none mx-auto px-5 h-[52px] flex items-center justify-between gap-4">
        ...
        {/* Search bar — centered, desktop lg+ only */}
        <button
          onClick={() => document.dispatchEvent(new KeyboardEvent("keydown", { key: "k", metaKey: true, bubbles: true }))}
          className="hidden lg:flex items-center gap-2 flex-1 max-w-[480px] px-4 py-2 rounded-xl transition-colors"
          style={{
        ...
        >
          ...
          <span className="text-[13px]">Rechercher sur nid.local...</span>
          <span className="ml-auto text-[11px] font-medium px-1.5 py-0.5 rounded" style={{ background: "var(--bg-page)", border: "0.5px solid var(--border)" }}>⌘K</span>
        </button>
