      ...
      <div className="flex gap-0">
        ...
        <div className="flex-1 min-w-0 px-4 py-3">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-wrap">
            ...
            <span className="hidden md:inline"><BookmarkButton postId={post.id} initialBookmarked={isBookmarked} /></span>
            <span className="hidden md:flex items-center gap-1 text-[12px] ml-auto" style={{ color: "var(--text-tertiary)" }}>
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
